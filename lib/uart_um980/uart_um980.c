...
QueueHandle_t um980_rtcm_queue;
#define UM980_RTCM_QUEUE_SIZE 20
...
void uart_um980_init(void)
{
    ...
    um980_rtcm_queue = xQueueCreate(UM980_RTCM_QUEUE_SIZE,
...
static void uart_um980_send_rtcm_task(void *pvParameters)
{
    ...
    while (1)
    {
        xQueueReceive(um980_rtcm_queue, &rtcm_received, portMAX_DELAY);
